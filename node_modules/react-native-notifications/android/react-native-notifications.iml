...
<module external.linked.project.id=":react-native-notifications" external.linked.project.path="$MODULE_DIR$" external.root.project.path="$MODULE_DIR$/../example/android" external.system.id="GRADLE" type="JAVA_MODULE" version="4">
  ...
  <component name="NewModuleRootManager" LANGUAGE_LEVEL="JDK_1_7" inherit-compiler-output="false">
    ...
    <content url="file://$MODULE_DIR$">
      ...
      <excludeFolder url="file://$MODULE_DIR$/build/intermediates/exploded-aar/com.facebook.react/react-native/0.38.0/jars" />
    ...
    <orderEntry type="library" exported="" scope="TEST" name="byte-buddy-agent-1.5.5" level="project" />
    ...
    <orderEntry type="library" exported="" scope="TEST" name="mockito-core-2.2.26" level="project" />
    ...
    <orderEntry type="library" exported="" name="react-native-0.38.0" level="project" />
    ...
    <orderEntry type="library" exported="" scope="TEST" name="byte-buddy-1.5.5" level="project" />
